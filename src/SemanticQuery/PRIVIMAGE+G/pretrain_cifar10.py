...
def main(opt):
    ...
    for epoch in range(opt.epochs):
        for i, data in enumerate(dataloader):
            ...
            real_labels = data[1].to(device) * nocond2cond
            batch_size = real_images.size(0)

            fake_labels = torch.randint(0, num_classes, (batch_size, ), device=device) * nocond2cond
            ...
            if all_steps%opt.fid_step == 0:
                ...
                def generator():
                    ...
                    for _ in range(num_sampling_rounds):
                        ...
                        fake_label = torch.randint(low=0, high=num_classes, size=(opt.batch_size, ), device=device) * nocond2cond
...
if __name__ == "__main__":
    ...
    parser.add_argument("--data_root", type=str, default="/bigtemp/fzv6en/datasets/imagenet32/")
    parser.add_argument("--stats_path", type=str, default="/bigtemp/fzv6en/datasets/cifar10.npz")
    parser.add_argument(
    "--specific_class",
    type=str,
    default="/u/fzv6en/kecen/RFF_DDPM/chosen_top1_classes_for_cifar10_epsilon0.01.pth"
)
    parser.add_argument(
    ...
    parser.add_argument(
        "--outf", default="pretrain_cifar1_top10", help="folder to output images and model checkpoints"
    )
