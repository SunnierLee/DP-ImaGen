...
def main(opt):
    ...
    try:
        dataset = ImageFolderDataset(
                opt.data_root, opt.imageSize, use_labels=False)
        num_classes = 1
    except ValueError:
    ...
    for epoch in range(opt.epochs):
        with BatchMemoryManager(
            ...
            for i, data in enumerate(memory_safe_data_loader):
                ...
                real_images = data[0].to(device).to(torch.float32) / 127.5 - 1.
                #real_labels = data[1].to(device)*0
...
if __name__ == "__main__":
    ...
    parser.add_argument("--data_root", type=str, default="/bigtemp/fzv6en/datasets/celeba_32.zip")
    parser.add_argument("--stats_path", type=str, default="/bigtemp/fzv6en/datasets/celeba_32.npz")
    parser.add_argument(
    ...
    #parser.add_argument("--netG", default="/u/fzv6en/kecen/BigGAN/celeba32/pretrain/pretrain_celeba32_all_e1/netG.pth", help="path to netG (to continue training)")
    #parser.add_argument("--netD", default="/u/fzv6en/kecen/BigGAN/celeba32/pretrain/pretrain_celeba32_all_e1/netD.pth", help="path to netD (to continue training)")
    parser.add_argument("--netG", default="/bigtemp/fzv6en/kecen0923/BigGAN/celeba32/pretrain_celeba32_top500/netG.pth", help="path to netG (to continue training)")
    parser.add_argument("--netD", default="/bigtemp/fzv6en/kecen0923/BigGAN/celeba32/pretrain_celeba32_top500/netD.pth", help="path to netD (to continue training)")
    parser.add_argument(
        "--outf", default="celeba32_e10_top500_update5", help="folder to output images and model checkpoints"
    )
