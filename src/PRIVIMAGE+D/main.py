...
if __name__ == '__main__':
    ...
    #parser.add_argument('--config', nargs="*", default=["configs_ours/cifar10_32/train_eps_10.0_b.yaml"])
    #parser.add_argument('--workdir', type=str, default='ours_b_run_test')
    parser.add_argument('--config', nargs="*", default=["configs/mnist_28/sample_eps_10.0.yaml"])
    parser.add_argument('--workdir', type=str, default='/bigtemp/fzv6en/kecen0923/DPDM/mnist/mnist_28_e10_384/sample50000')
    parser.add_argument('--mode', choices=['train', 'eval', 'sample_show'], required=True)
