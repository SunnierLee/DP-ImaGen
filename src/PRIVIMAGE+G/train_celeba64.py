...
if __name__ == "__main__":
    ...
    parser.add_argument("--data_root", type=str, default="/bigtemp/fzv6en/datasets/celeba_64.zip")
    ...
    parser.add_argument("--netG", default="/bigtemp/fzv6en/kecen0923/BigGAN/celeba64/pretrain_celeba64_top500/netG.pth", help="path to netG (to continue training)")
    parser.add_argument("--netD", default="/bigtemp/fzv6en/kecen0923/BigGAN/celeba64/pretrain_celeba64_top500/netD.pth", help="path to netD (to continue training)")
    parser.add_argument(
        "--outf", default="celeba64_e10_top500_u2", help="folder to output images and model checkpoints"
    )
