...
def main(opt):
    ...
    with open_url(
            'https://api.ngc.nvidia.com/v2/models/nvidia/research/stylegan3/versions/1/files/metrics/inception-2015-12-05.pkl') as f:
...
if __name__ == "__main__":
    ...
    parser.add_argument(
        "--outf", default="pretrain_celeba32_top500", help="folder to output images and model checkpoints"
    )
